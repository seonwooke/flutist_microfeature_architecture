...
```
cart_interface/
├── cart_interface_example/        # Example layer
│   └── lib/
├── cart_interface_interface/      # Interface layer
│   └── lib/
├── cart_interface_implementation/ # Implementation layer
│   └── lib/
├── cart_interface_tests/          # Tests layer
│   └── lib/
└── cart_interface_testing/        # Testing layer
    └── lib/
```
