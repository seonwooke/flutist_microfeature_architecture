...
```dart
import 'package:cart_example/cart_example.dart';
```
...
```
cart_example/
├── cart_example_example/        # Example layer
│   └── lib/
├── cart_example_interface/      # Interface layer
│   └── lib/
├── cart_example_implementation/ # Implementation layer
│   └── lib/
├── cart_example_tests/          # Tests layer
│   └── lib/
└── cart_example_testing/        # Testing layer
    └── lib/
```
