...
```dart
import 'package:cart_tests/cart_tests.dart';
```
...
```
cart_tests/
├── cart_tests_example/        # Example layer
│   └── lib/
├── cart_tests_interface/      # Interface layer
│   └── lib/
├── cart_tests_implementation/ # Implementation layer
│   └── lib/
├── cart_tests_tests/          # Tests layer
│   └── lib/
└── cart_tests_testing/        # Testing layer
    └── lib/
```
