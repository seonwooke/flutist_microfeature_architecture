...
```
cart_implementation/
├── cart_implementation_example/        # Example layer
│   └── lib/
├── cart_implementation_interface/      # Interface layer
│   └── lib/
├── cart_implementation_implementation/ # Implementation layer
│   └── lib/
├── cart_implementation_tests/          # Tests layer
│   └── lib/
└── cart_implementation_testing/        # Testing layer
    └── lib/
```
