...
```
cart_testing/
├── cart_testing_example/        # Example layer
│   └── lib/
├── cart_testing_interface/      # Interface layer
│   └── lib/
├── cart_testing_implementation/ # Implementation layer
│   └── lib/
├── cart_testing_tests/          # Tests layer
│   └── lib/
└── cart_testing_testing/        # Testing layer
    └── lib/
```
