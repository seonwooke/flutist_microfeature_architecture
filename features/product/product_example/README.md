...
```dart
import 'package:product_example/product_example.dart';
```
...
```
product_example/
├── product_example_example/        # Example layer
│   └── lib/
├── product_example_interface/      # Interface layer
│   └── lib/
├── product_example_implementation/ # Implementation layer
│   └── lib/
├── product_example_tests/          # Tests layer
│   └── lib/
└── product_example_testing/        # Testing layer
    └── lib/
```
