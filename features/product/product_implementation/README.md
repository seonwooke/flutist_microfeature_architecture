...
├── product_implementation_example/        # Example layer
│   └── lib/
├── product_implementation_interface/      # Interface layer
│   └── lib/
├── product_implementation_implementation/ # Implementation layer
│   └── lib/
├── product_implementation_tests/          # Tests layer
│   └── lib/
└── product_implementation_testing/        # Testing layer
    └── lib/
```
