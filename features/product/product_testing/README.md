...
```
product_testing/
├── product_testing_example/        # Example layer
│   └── lib/
├── product_testing_interface/      # Interface layer
│   └── lib/
├── product_testing_implementation/ # Implementation layer
│   └── lib/
├── product_testing_tests/          # Tests layer
│   └── lib/
└── product_testing_testing/        # Testing layer
    └── lib/
```
