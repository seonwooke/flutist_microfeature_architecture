...
```
product_interface/
├── product_interface_example/        # Example layer
│   └── lib/
├── product_interface_interface/      # Interface layer
│   └── lib/
├── product_interface_implementation/ # Implementation layer
│   └── lib/
├── product_interface_tests/          # Tests layer
│   └── lib/
└── product_interface_testing/        # Testing layer
    └── lib/
```
