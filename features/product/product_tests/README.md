...
```dart
import 'package:product_tests/product_tests.dart';
```
...
```
product_tests/
├── product_tests_example/        # Example layer
│   └── lib/
├── product_tests_interface/      # Interface layer
│   └── lib/
├── product_tests_implementation/ # Implementation layer
│   └── lib/
├── product_tests_tests/          # Tests layer
│   └── lib/
└── product_tests_testing/        # Testing layer
    └── lib/
```
