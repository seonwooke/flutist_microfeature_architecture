...
├── network_implementation_interface/      # Interface layer
│   └── lib/
├── network_implementation_implementation/ # Implementation layer
│   └── lib/
├── network_implementation_tests/          # Tests layer
│   └── lib/
└── network_implementation_testing/        # Testing layer
    └── lib/
```
