...
```
network_testing/
├── network_testing_interface/      # Interface layer
│   └── lib/
├── network_testing_implementation/ # Implementation layer
│   └── lib/
├── network_testing_tests/          # Tests layer
│   └── lib/
└── network_testing_testing/        # Testing layer
    └── lib/
```
