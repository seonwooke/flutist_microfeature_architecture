...
```
network_interface/
├── network_interface_interface/      # Interface layer
│   └── lib/
├── network_interface_implementation/ # Implementation layer
│   └── lib/
├── network_interface_tests/          # Tests layer
│   └── lib/
└── network_interface_testing/        # Testing layer
    └── lib/
```
